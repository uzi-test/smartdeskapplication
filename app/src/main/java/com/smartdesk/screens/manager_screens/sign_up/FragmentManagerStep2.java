...
public class FragmentManagerStep2 extends Fragment implements View.OnClickListener {
    ...
    public FragmentManagerStep2() {
    }

    public FragmentManagerStep2(Context mContext) {
    ...
    public void validationsAndGetValues() {
        ScreenMangerSignup.isOkayStep2 = true;
        if (Constants.const_usersSignupDTO.getProfilePicture() == null) {
            ScreenMangerSignup.isOkayStep2 = false;
        ...
        try {
            ...
            alertDialogBuilder.setPositiveButton("GO", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    intent.setData(uri);
                    FragmentManagerStep2.this.startActivityForResult(intent, PermisionCode.MY_STORAGE_PERMISSION_CODE);
                }
            });
