...
public class FragmentDeskUserRequest extends Fragment {
    ...
    public FragmentDeskUserRequest() {
    }

    public FragmentDeskUserRequest(Activity context) {
    ...
    public void showDataOnList(Boolean isSwipe) {
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            FirebaseConstants.firebaseFirestore.collection(FirebaseConstants.usersCollection).whereEqualTo("role", Constants.deskUserRole).whereEqualTo("userStatus", Constants.newAccountStatus).get()
...
//                                redSnackBar(context, "No Internet!", Snackbar.LENGTH_SHORT);
    ...
    public class Adapter extends RecyclerView.Adapter<FragmentDeskUserRequest.Adapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public FragmentDeskUserRequest.Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new FragmentDeskUserRequest.Adapter.ViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(@NonNull FragmentDeskUserRequest.Adapter.ViewHolder holder, final int position) {
