...
public class FragmentDeskUserStep1 extends Fragment implements View.OnClickListener {
    ...
    public FragmentDeskUserStep1() {
    }

    public FragmentDeskUserStep1(Context mContext) {
    ...
    private void initKeyBoardListener() {
        try {
            ...
            final View decorView = ((ScreenDeskUserSignup) signupContext).getWindow().getDecorView();
                    ...
                    try {
                        ...
                        if (lastVisibleDecorViewHeight != 0) {
                            if (lastVisibleDecorViewHeight > visibleDecorViewHeight + MIN_KEYBOARD_HEIGHT_PX) {
                                ((ScreenDeskUserSignup) signupContext).nextBtn.setVisibility(View.GONE);
                                ((ScreenDeskUserSignup) signupContext).linearHide.setVisibility(View.GONE);
                            } else if (lastVisibleDecorViewHeight + MIN_KEYBOARD_HEIGHT_PX < visibleDecorViewHeight) {
                                ((ScreenDeskUserSignup) signupContext).nextBtn.setVisibility(View.VISIBLE);
                                ((ScreenDeskUserSignup) signupContext).linearHide.setVisibility(View.VISIBLE);
                            }
                        }
...
//                startActivity(intent);
    ...
    public void validationsAndGetValues() {
        ScreenDeskUserSignup.isOkayStep1 = true;
        ...
        if(!UtilityFunctions.isValidEmail(Constants.const_usersSignupDTO.getWorkerEmail())){
            ScreenDeskUserSignup.isOkayStep1 = false;
        ...
        if (ScreenDeskUserSignup.isOkayStep1) {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.termscheckbox) {
            if (termscheckbox.isChecked()) {
                ((ScreenDeskUserSignup) signupContext).nextBtn.setBackgroundTintList(ContextCompat.getColorStateList(signupContext, R.color.SmartDesk_Blue));
                ((ScreenDeskUserSignup) signupContext).nextBtn.setEnabled(true);
            } else {
                ((ScreenDeskUserSignup) signupContext).nextBtn.setBackgroundTintList(ContextCompat.getColorStateList(signupContext, R.color.SmartDesk_Blue_Oppaque));
                ((ScreenDeskUserSignup) signupContext).nextBtn.setEnabled(false);
                ScreenDeskUserSignup.isOkayStep1 = false;
            }
        }
    }
