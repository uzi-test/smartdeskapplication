...
public class PageStepIndicator extends View {
    ...
    private static final int DEFAULT_TEXT_COLOR = R.color.black_color;
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            stepColor = attr.getColor(R.styleable.PageStepIndicator_pgStepColor, getColor(context, DEFAULT_STEP_COLOR));
            currentColor = attr.getColor(R.styleable.PageStepIndicator_pgCurrentStepColor, getColor(context, DEFAULT_CURRENT_STEP_COLOR));
            backgroundColor = attr.getColor(R.styleable.PageStepIndicator_pgBackgroundColor, getColor(context, DEFAULT_BACKGROUND_COLOR));
            textColor = attr.getColor(R.styleable.PageStepIndicator_pgTextColor, getColor(context, DEFAULT_TEXT_COLOR));
            secondaryTextColor = attr.getColor(R.styleable.PageStepIndicator_pgSecondaryTextColor, getColor(context, DEFAULT_SECONDARY_TEXT_COLOR));
            pageInActiveTitleColor = attr.getColor(R.styleable.PageStepIndicator_pgInActiveTitleColor, getColor(context, DEFAULT_INACTIVE_TITLE));
            pageActiveTitleColor = attr.getColor(R.styleable.PageStepIndicator_pgActiveTitleColor, getColor(context, DEFAULT_TEXT_COLOR));
